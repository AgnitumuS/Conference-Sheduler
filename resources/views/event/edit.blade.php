        ...
        <div class="col-md-10 col-md-offset-1" >
            <div class="panel panel-default" >
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(array('url' => 'event/'.$event->id, 'method' => 'PUT')) !!}
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::select('room', $rooms, $event->room->id, ['class' => 'form-control', 'placeholder'=>' ', 'required']) }}
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                {{ Form::label('start','Дата/время начала') }}
                                {{ Form::datetime('start', $event->start, array('class' => 'form-control', 'required', 'id'=>'start_datetimepicker')) }}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                {{ Form::label('stop','Дата/время окончания') }}
                                {{ Form::datetime('stop', $event->stop, array('class' => 'form-control', 'required', 'id'=>'stop_datetimepicker')) }}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
